...
def get_record_history(
    table_name: str, record_id: str, depth: int = 0, cache_dict: dict = {}
):
    if table_name not in cache_dict:
        cache_dict[table_name] = CustomDF(
            "record_tracing", partition_name=table_name
        ).data
    ...
    if df.height > 0:
        ...
        for item in recursive_list:
            ...
            get_record_history(
                source_table, source_id, depth=depth + 1, cache_dict=cache_dict
            )
