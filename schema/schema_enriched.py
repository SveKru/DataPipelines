...
def get_enriched_schema(table_name: str = '') -> dict:
    ...
    schema_dict = {
        ...
        'columns': {
            'player_uuid':pl.String,
            'season':pl.Int64,
            'twopoint_locations':pl.List(pl.Struct([pl.Field("xnormalize", pl.Decimal(25,10)), pl.Field("ynormalize", pl.Decimal(25,10))])),
            'from_date': pl.Date,
            'to_date': pl.Date,
            'RecordID': pl.String,
        },
        ...
        'columns': {
            'player_uuid':pl.String,
            'season':pl.Int64,
            'threepoint_locations':pl.List(pl.Struct([pl.Field("xnormalize", pl.Decimal(25,10)), pl.Field("ynormalize", pl.Decimal(25,10))])),
            'from_date': pl.Date,
            'to_date': pl.Date,
            'RecordID': pl.String,
        },
